...
// import 'package:instagram_clone/features/videocall/controllers/webRtcVideoService.dart';
...
//           height: AppHelperFunctions.screenHeight(context),
//           width: AppHelperFunctions.screenWidth(context),
//           child: remoteVideo.srcObject!=null
//               ? RTCVideoView(remoteVideo)
//               : CachedNetworkImage(
//                   imageUrl:
...
//         await WebRTCVideoController.instance
//             .updateDocStatus(widget.receiverId!, "ended");
//       } else {
//         await WebRTCVideoController.instance
//             .updateDocStatus(widget.videoCall!.initiatorId, "ended");
//       }
