            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Container(
                    height: 150,
                    width: AppHelperFunctions.screenWidth(context) * 0.7,
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage(isDark
                                ? AppImageStrings.whiteInstaLogo
                                : AppImageStrings.darkInstaLogo),
                            fit: BoxFit.contain)),
                  ),
        ...
        children: [
          ...
          Obx(
            () => ElevatedButton(
              onPressed: () async {
                print("pressed");
                await loginController.loginwithEmailPassword();
              },
...
class EyeSlash extends StatelessWidget {
  const EyeSlash({super.key});

  @override
  Widget build(BuildContext context) {
    return Container(
      child: Obx(() => loginController.obscureText.value
          ? IconButton(
              onPressed: () {
